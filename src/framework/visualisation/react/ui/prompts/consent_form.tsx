...
const description = new TextBundle()
  .add('en', 'Determine at the end of this page whether you would like to donate the data below. With your donation you contribute to the previously described research. Thank you in advance.')
